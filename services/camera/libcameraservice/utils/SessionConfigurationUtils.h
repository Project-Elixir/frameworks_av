...
bool roundBufferDimensionNearest(int32_t width, int32_t height, int32_t format,
        ...
        /*out*/int32_t* outWidth, /*out*/int32_t* outHeight, bool mPrivilegedClient);
...
binder::Status createSurfaceFromGbp(
        ...
        int32_t colorSpace, bool mPrivilegedClient=false);
...
convertToHALStreamCombination(
    ...
    bool overrideForPerfClass, bool *earlyExit, bool mPrivilegedClient = false);
