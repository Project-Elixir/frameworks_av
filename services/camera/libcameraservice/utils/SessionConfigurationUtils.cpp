...
bool roundBufferDimensionNearest(int32_t width, int32_t height,
        ...
        /*out*/int32_t* outHeight, bool mPrivilegedClient) {
    ...
    if (mPrivilegedClient == true && bestWidth == -1 &&
...
binder::Status createSurfaceFromGbp(
        ...
        int32_t colorSpace, bool mPrivilegedClient) {
...
convertToHALStreamCombination(
        ...
        bool overrideForPerfClass, bool *earlyExit, bool mPrivilegedClient) {
    using SensorPixelMode = aidl::android::hardware::camera::metadata::SensorPixelMode;
